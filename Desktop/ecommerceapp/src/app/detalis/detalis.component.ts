  ...
  cardlist: Array<Card> = [
    {
      ...
      image:
        'https://mcprod.hyperone.com.eg/media/catalog/product/cache/1ca275941aea0ae98b372dcb44b7c67a/6/2/6223000191392_ugyh.png',
      rate: 7.5,
      count: 0,
      description: 'Generic',
      price: '80.00',
      reviews: ['reviews 1', 'Good Product', 'Recommended'],
      id: '1',
    },
    {
...
detalis:any;
  ...
  ngOnInit(): void {
// console.log(detalis);
this.activa = this.activeroute.snapshot.params['id'];
this.detalis=this['cardlist'].find((card:any) => card.id == Number(this.activa));
// console.log(
//   this['cardlist'].find((card: any) => card.id == Number(this.activa))
// );
  }
...
// function card(this: void, value: Card, index: number, obj: Card[]): value is any {
